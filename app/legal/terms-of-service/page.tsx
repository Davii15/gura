      ...
      <div className="container mx-auto px-4 py-12 max-w-3xl">
        <div className="prose prose-emerald max-w-none">
          ...
          <section className="space-y-6">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-emerald-800 mb-3">5. Governing Law</h2>
              <p className="text-gray-700">
                These terms and conditions are governed by and construed in accordance with the laws of Kenya, and you
                irrevocably submit to the exclusive jurisdiction of the courts located in Nairobi, Kenya.
              </p>
            </div>

            <div>
              <h2 className="text-2xl font-semibold text-emerald-800 mb-3">6. Contact Information</h2>
              <p className="text-gray-700">
